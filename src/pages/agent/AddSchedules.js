...
import { loadRoutesWithID, addSchedule } from '../../redux/actions/SchedulesActions'
...
export default connect(mapStateToProps, { loadRoutesWithID, getBusForAgent, addSchedule })(
  AddSchedules
)
